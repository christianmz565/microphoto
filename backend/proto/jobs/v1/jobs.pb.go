...
const (
	...
	JobType_JOB_TYPE_CONTRAST         JobType = 9
	JobType_JOB_TYPE_SEPIA            JobType = 10
	JobType_JOB_TYPE_VIGNETTE         JobType = 11
)
...
const file_jobs_v1_jobs_proto_rawDesc = "" +
	"\n" +
	"\x12jobs/v1/jobs.proto\x12\ajobs.v1\"R\n" +
	"\x06Region\x12\f\n" +
	...
	"\x13JOB_TYPE_BRIGHTNESS\x10\x06\x12\x1a\n" +
	"\x16JOB_TYPE_VIDEO_EXTRACT\x10\a\x12\x1d\n" +
	"\x19JOB_TYPE_VIDEO_REASSEMBLE\x10\b\x12\x15\n" +
	"\x11JOB_TYPE_CONTRAST\x10\t\x12\x12\n" +
	"\x0eJOB_TYPE_SEPIA\x10\n" +
	"\x12\x15\n" +
	"\x11JOB_TYPE_VIGNETTE\x10\v*t\n" +
	"\tJobStatus\x12\x1a\n" +
...
var file_jobs_v1_jobs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
